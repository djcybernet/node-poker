define(["io", "send", "classes/game", "classes/chat", "classes/account"], function(io, send, GameClass, ChatClass, AccountClass) {
	...
	io.sockets.on('connection', function (socket) {
		...
		// Remove this.
		send.client(socket, 'Chat.add', [ 'system', { 'message' : 'Please take note that this application is still under development and is not fully functional or optimized. Access from more than one client or tab to simulate multiple users. Not (yet) optimized for window sizes smaller than 1280 pixels in width.' } ]);
